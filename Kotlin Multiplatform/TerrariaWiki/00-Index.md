...
Pendiente para próxima sesión GLM-5.2:
- Validación en móvil: las 50 imágenes de la primera categoría deberían cargar instantáneamente sin errores.
- Iteración 7: búsqueda global desde Home (action=query&list=search) que el usuario pidió pero quedó fuera de esta iteración.
